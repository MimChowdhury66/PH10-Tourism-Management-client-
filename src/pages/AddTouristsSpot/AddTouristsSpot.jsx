                ...
                <div className=" grid gap-3 w-full justify-center mb-3">
                    ...
                    <div className="grid lg:flex gap-3 w-full">
                        <div className="form-control lg:w-1/2 ">
                            <label className="input input-bordered flex items-center gap-2">
                                User Email
                                <input type="text" name="email" className="grow w-full" placeholder="Email" {...register("Email")} />
                            </label>
                        </div>
                        <div className="form-control lg:w-1/2">
                            <label className="input input-bordered flex items-center gap-2">
                                User Name
                                <input type="text" name="user" className="grow w-full" placeholder="User Name" {...register("UserName")} />
                            </label>
                        </div>
                    </div>
